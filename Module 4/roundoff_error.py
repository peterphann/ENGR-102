...
print(f'a = {a}')
b = a * 7
print(f'b = a * 7 = {b}') # Yes, the value of b is 1 (or rather, 1.0) as expected.

c = 2 * a
d = 5 * a
f = c + d
print(f'f = 2 * a + 5 * a = {f}') # No, the value of f is not quite 1
...
print(f'y = x * x * 3 = {y}')
z = x * 3 * x
print(f'z = x * 3 * x = {z}') # While the value of y is 1, the value of z has a roundoff error, possibly due to the order of the expression
